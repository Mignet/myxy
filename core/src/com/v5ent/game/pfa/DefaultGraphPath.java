...
/** Default implementation of a {@link MyGraphPath} that uses an internal {@link Array} to store nodes or connections.
 * 
 * @param <N> Type of node
 * 
 * @author davebaol */
public class DefaultGraphPath<N> implements MyGraphPath<N> {
