...
public final class Utility {
	...
	private final static String LOADING_TEXTURE_PATH = "skins/loading.pack";
	...
	public static TextureAtlas LOADING_TEXTUREATLAS = new TextureAtlas(LOADING_TEXTURE_PATH);
