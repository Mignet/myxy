...
import com.v5ent.game.inventory.InventoryItem.ItemUseType;
...
public class InventoryUI extends Window implements InventorySubject, InventorySlotObserver{
    ...
    public InventoryUI(){
        super("包裹", Utility.STATUSUI_SKIN, "solidbackground");
        ...
        Label DPLabel = new Label("防御力: ", Utility.STATUSUI_SKIN);
        _DPValLabel = new Label(String.valueOf(_DPVal), Utility.STATUSUI_SKIN);

        Label APLabel = new Label("攻击力: ", Utility.STATUSUI_SKIN);
