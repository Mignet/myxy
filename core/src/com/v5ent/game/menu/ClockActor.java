...
public class ClockActor extends Label {
    ...
    private static String PM = "下午";
    private static String AM = "上午";
    private static String FORMAT = "%s %02d:%02d";
    ...
    private void init(){
        String time = String.format(FORMAT, _isAfternoon?PM:AM, 0, 0);
        this.setText(time);
        this.pack();
    }
    ...
    public void act(float delta){
        ...
        String time = String.format(FORMAT, _isAfternoon ? PM : AM, hours, minutes);
        this.setText(time);
    }
