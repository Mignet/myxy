...
import com.v5ent.game.ui.InventoryObserver;
    ...
    private Timer.Task getPlayerAttackCalculationTimer() {
        return new Timer.Task() {
            ...
            public void run() {
                ...
                Gdx.app.error(TAG, "Player attacks " + _currentOpponent.getEntityConfig().getEntityID() + " leaving it with HP: " + currentOpponentHP);
    ...
    private Timer.Task getOpponentAttackCalculationTimer() {
        return new Timer.Task() {
            ...
            public void run() {
                ...
                Gdx.app.error(TAG, "Player HIT for " + damage + " BY " + _currentOpponent.getEntityConfig().getEntityID() + " leaving player with HP: " + hpVal);
